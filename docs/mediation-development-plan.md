...
1. 完成 Phase 0/1（冻结 + 测试骨架）。
2. 完成 H（Phase 2）并让 A-H 都可消费版本锚点。
3. 完成 A/B/C（Phase 3）并通过模块 P0 测试。
4. 完成 D/E（Phase 4）并打通同步主链。
5. 完成 F/G（Phase 5）并打通异步闭环与回放。
6. 跑通全量功能矩阵，达到 100% 通过。
7. 再进入 SDK 集成文档与发布演练（Phase 6）。
